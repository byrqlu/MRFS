...
# Dataset Config
parser.add_argument('--dataset_path', default="./dataset/FMB", type=str, help='absolute path of the dataset root')
...
parser.add_argument('--class_names', default=['background', 'Road', 'Sidewalk', 'Building', 'Lamp', 'Sign', 'Vegetation', 'Sky', 'Person', 'Car', 'Truck', 'Bus', 'Motorcycle', 'Bicycle', 'Pole'],
                    type=list, help='the class names of all classes')
parser.add_argument('--num_train_imgs', default=1220, type=int, help='')
parser.add_argument('--num_eval_imgs', default=280, type=int, help='')
# Image Config
...
# Val Config
parser.add_argument('--eval_size', default=[600, 800], type=list, help='image size')
# Store Config
